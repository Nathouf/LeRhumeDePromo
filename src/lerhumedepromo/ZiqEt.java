...
public class ZiqEt extends Etudiant{
	...
	public ZiqEt(){
       ...
       public void setWeiZiqEt(){//adjustement des coefficients par rapport la participation des ziqEt au Wei. La participation est initialisé au hasard avec random
